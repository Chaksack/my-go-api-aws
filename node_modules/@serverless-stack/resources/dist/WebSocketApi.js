...
class WebSocketApi extends constructs_1.Construct {
    constructor(scope, id, props) {
        ...
        // Create Api
        ////////////////////
        if ((0, Construct_1.isCDKConstruct)(webSocketApi)) {
            this.webSocketApi = webSocketApi;
        }
        else {
            // Validate input
            if ((0, Construct_1.isCDKConstruct)(webSocketStage)) {
