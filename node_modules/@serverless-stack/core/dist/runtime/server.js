...
class Server {
    constructor(opts) {
        ...
        this.opts = opts;
        this.app.post(`/:proc/:fun/${API_VERSION}/runtime/init/error`, express_1.default.json({
            strict: false,
        ...
        this.app.post(`/:proc/:fun/${API_VERSION}/runtime/invocation/:awsRequestId/response`, express_1.default.json({
            strict: false,
            type: ["application/json", "application/*+json"],
            limit: "10mb",
        }), (req, res) => {
        ...
        this.app.post(`/:proc/:fun/${API_VERSION}/runtime/invocation/:awsRequestId/error`, express_1.default.json({
            strict: false,
            type: ["application/json", "application/*+json"],
            limit: "10mb",
        }), (req, res) => {
