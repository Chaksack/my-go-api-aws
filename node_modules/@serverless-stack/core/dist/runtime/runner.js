...
const PythonRunner = (opts) => {
  const PATH = (() => {
    if (process.env.VIRTUAL_ENV) {
      const runtimeDir =
        os_1.default.platform() === "win32" ? "Scripts" : "bin";
      return [
...
function resolve(runtime) {
  if (runtime.startsWith("node")) return exports.NodeRunner;
  if (runtime.startsWith("go")) return exports.GoRunner;
  if (runtime.startsWith("python")) return exports.PythonRunner;
  if (runtime.startsWith("dotnetcore")) return exports.DotnetRunner;
